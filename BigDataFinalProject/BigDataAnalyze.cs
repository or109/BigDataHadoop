...
namespace BigDataFinalProject
{
    ...
    public partial class BigDataAnalyze : Form
    {
        // Consts
        string USER_NAME_FOR_HOST = BigDataFinalProject.Properties.Settings.Default.USER_NAME_FOR_HOST;
        string PASSWORD_FOR_HOST = BigDataFinalProject.Properties.Settings.Default.PASSWORD_FOR_HOST;
        ...
        const string COMMA = ",";
        private int MAX_ROW_NUMBER_INPUT_FILE = int.Parse(BigDataFinalProject.Properties.Settings.Default.MAX_ROW_NUMBER_INPUT_FILE);

        // Variables
        private int stkNum;
        private int daysNum;
        private int clusterNum;
        private string clouderaIP = BigDataFinalProject.Properties.Settings.Default.IP_ADDRESS;

        private Dictionary<string, string> dctStocks;
        private List<Stock> lstStocks;
        private DataTransferManager dtmDataTransfer;
        private List<FeaturesColumnNumbers> lstFeatures;
        private Dictionary<string, int> dctClustering;

        public BigDataAnalyze()
        {
            InitializeComponent();
        }
        ...
        {
            this.dtmDataTransfer = new DataTransferManager();
        ...
        {
            ReportForm frmReport = new ReportForm(this.lstStocks);
